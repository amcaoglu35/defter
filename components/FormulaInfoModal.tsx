...
export const FORMULA_DICTIONARY: Record<string, FormulaExplanation> = {
  ...
  merton: {
    title: "Merton İflas Modeli (Distance to Default)",
    category: "Değerleme",
    formula: "Black-Scholes Opsiyon Teorisi Bilanço Temerrüt Olasılığı",
    whatItDoes: "Şirketin piyasa değeri ve borç yapısını opsiyon gibi modelleyerek 1 yıl içinde iflas etme olasılığını (%) çıkarır.",
    howToRead: "< %3.0 ise 'Çok Güvenli', > %10.0 ise 'Kritik Borç / Temerrüt Riski'.",
    benchmarkTarget: "< %4.0",
  },
  hurst: {
    title: "Hurst Exponent (H — Fraktal Trend vs Ortalamaya Dönüş)",
    category: "Değerleme",
    formula: "Yeniden Ölçeklendirilmiş Aralık (R/S) Fraktal Eğim Analizi",
    whatItDoes: "Fiyatların kalıcı bir momentum trendinde mi yoksa ortalamasına sertçe dönecek bir aşırılıkta mı olduğunu belirler.",
